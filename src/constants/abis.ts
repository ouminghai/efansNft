export const FAN_BADGE_NFT_ADDRESS = "0x28591844b45975b96BCB2df43B9DfE88C41E7d64";
export const POINT_SYSTEM_ADDRESS = "0x9E6F2dc0024f881dD543C8C0e1B4183C87ece34b";
...
export const POINT_SYSTEM_ABI = [
  ...
  {
    "inputs": [{ "internalType": "string", "name": "songTitle", "type": "string" }],
    "name": "supportSong",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
